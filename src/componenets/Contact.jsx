...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_36mnydh', 'template_elqs8kk', form.current, '-0DEzK1Cr-wlDoNjj')
          .then((result) => {
  ...
  return (
    <>
      <section id='contact' className="bg-gray-100 lg:flex justify-around py-20 lg:py-[120px] w-full overflow-hidden relative z-10">
        <div className="lg:flex lg:w-full lg:justify-center">
          <div className="lg:flex lg:w-3/5 gap-10 items-center">
            ...
            <div className="w-full px-4 max-w-[200rem]">
                ...
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div>
                    <button
                      ...
                      className="w-full p-3 bg-indigo-600 text-white transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
